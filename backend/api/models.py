...
def create_test_data():
    ...
    chemist1 = Chemist.objects.create(
        name="安東尼·拉瓦錫",
        era=1774,
        description="法國化學家，被譽為「現代化學之父」，他徹底改變了人類對化學反應的理解。拉瓦錫最著名的貢獻是推翻了「燃素說」，並提出燃燒其實是一種與氧氣結合的反應。他首創化學反應的質量守恆定律：「在一個封閉系統中，反應前後的總質量保持不變」，為化學計算奠定基礎。拉瓦錫不僅是實驗科學家，也是一位制度改革者，推動標準化化學命名法，使化學語言更加科學與一致。不幸的是，他在法國大革命期間被處以死刑，但他的科學遺產至今仍深深影響著化學世界。",
        position_x=0,
        position_y=0,
        position_z=0,
    ...
    chemist2 = Chemist.objects.create(
        name="德米特里·門捷列夫",
        era=1869,
        description="俄羅斯化學家，被譽為元素週期表之父。他在1869年提出了第一張有系統的元素週期表，將已知元素按照原子量大小與化學性質週期性排列，令人驚訝的是，他大膽地預測了當時尚未發現的元素及其性質，如鍺、鎵與鍶，後來的實驗也證實了他的預測準確無誤。",
        position_x=2,
        position_y=0,
        position_z=0,
    ...
    chemist3 = Chemist.objects.create(
        name="瑪麗·居里",
        era=1898,
        description="波蘭裔法國物理學家和化學家，以對放射性現象的開創性研究聞名於世。她是歷史上第一位獲得諾貝爾獎的女性，也是唯一一位同時獲得**物理學獎（1903）與化學獎（1911）的科學家。瑪麗·居里與丈夫皮埃爾·居里一同發現了釙（Polonium）與鐳（Radium）**兩種放射性元素，並開創了放射化學這個全新領域。",
        position_x=-2,
        position_y=0,
        position_z=0,
